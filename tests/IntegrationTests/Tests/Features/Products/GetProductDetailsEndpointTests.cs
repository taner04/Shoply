...
public sealed class GetProductDetailsEndpointTests(TestingFixture fixture) : TestingBase(fixture)
{
    ...
    public async Task GetProductDetails_Should_Return200_With_All_Fields()
    {
        ...
        // Act
        var response = await client.GetProductDetailsAsync(productId, CurrentCancellationToken);
    ...
    public async Task GetProductDetails_Should_Return_Correct_Data_For_Each_Product_Independently()
    {
        ...
        var productId1 = product1.Id.Value;
        var productId2 = product2.Id.Value;
        var productId3 = product3.Id.Value;

        // Act & Assert - Verify each product returns correct data
        var response1 = await client.GetProductDetailsAsync(productId1, CurrentCancellationToken);
        ...
        var response2 = await client.GetProductDetailsAsync(productId2, CurrentCancellationToken);
        ...
        var response3 = await client.GetProductDetailsAsync(productId3, CurrentCancellationToken);
    ...
    public async Task GetProductDetails_Should_Return404_For_Deleted_Product()
    {
        ...
        var response1 = await client.GetProductDetailsAsync(productId, CurrentCancellationToken);
        Assert.Equal(HttpStatusCode.OK, response1.StatusCode);
        ...
        var response2 = await client.GetProductDetailsAsync(productId, CurrentCancellationToken);
