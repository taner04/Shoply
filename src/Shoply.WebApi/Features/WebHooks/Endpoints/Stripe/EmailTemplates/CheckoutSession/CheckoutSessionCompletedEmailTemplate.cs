...
internal sealed class CheckoutSessionCompletedEmailTemplate(string userEmail, Order order)
    : UserEmailTemplate(userEmail)
{
    ...
    protected override string BuildBody()
    {
        ...
        sb.AppendLine(
            "Our team is preparing your package. You will receive another email as soon as your order ships.");
        sb.AppendLine("</div>");
