...
public record StripeEventObjectV2(
        ...
        [property: JsonPropertyName("data")] DataV2 Data,
        [property: JsonProperty("livemode")]
        [property: JsonPropertyName("livemode")] bool? Livemode,
        [property: JsonProperty("reason")]
        [property: JsonPropertyName("reason")] object Reason,
        [property: JsonProperty("related_object")]
        [property: JsonPropertyName("related_object")] RelatedObjectV2 RelatedObject,
