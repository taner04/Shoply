...
public class CreateOrderEmailTemplate(string userEmail, Order order) : UserEmailTemplate(userEmail)
{
    public override string Subject { get; } = $"Order confirmation - Order #{order.Id}";
