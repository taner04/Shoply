...
public sealed class GetProductsQueryHandler(ApplicationDbContext context)
    : IQueryHandler<GetProductsQuery, PaginationResponse<Product>>
{
    private const int MaxPageSize = 100;

    public async ValueTask<PaginationResponse<Product>> Handle(GetProductsQuery query,
